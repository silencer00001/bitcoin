...
Modifications
-------------
This branch is based on the current [master](https://github.com/bitcoin/bitcoin/tree/master) and includes the minimal required changes to allow transaction lookups based on an address.
