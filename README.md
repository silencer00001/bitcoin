...
This branch is based on the [0.9](https://github.com/dexX7/bitcoin/tree/0.9) branch of Bitcoin Core and includes the required changes to allow extended transaction lookups based on an address.
