...
int ClassAgnostic_send(const std::string &senderAddress, const std::string &receiverAddress, const std::string &redemptionAddress, const std::vector<unsigned char> &data, uint256 &txid, int64_t additional = 0);
