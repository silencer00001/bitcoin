...
int populateRPCTransactionObject(const uint256& txid, Object *txobj, std::string filterAddress = "")
{
    ...
    if (isMPTx)
    {
        ...
        if (!(MSC_TYPE_MDEX_NEW == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PRICE == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PAIR == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_ECOSYSTEM == MPTxTypeInt)) txobj->push_back(Pair("propertyid", propertyId));
        ...
        if (!(MSC_TYPE_MDEX_NEW == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PRICE == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PAIR == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_ECOSYSTEM == MPTxTypeInt)) txobj->push_back(Pair("divisible", divisible));
        if (!(MSC_TYPE_MDEX_NEW == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PRICE == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PAIR == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_ECOSYSTEM == MPTxTypeInt)) txobj->push_back(Pair("amount", FormatMP(propertyId, amount)));
        if (crowdPurchase)
        {
        ...
        if (MSC_TYPE_MDEX_NEW == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PRICE == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_PAIR == MPTxTypeInt || MSC_TYPE_MDEX_CANCEL_ECOSYSTEM == MPTxTypeInt)
        {
