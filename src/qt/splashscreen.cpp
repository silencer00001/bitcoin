    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString versionText     = QString("Experimental UI %1").arg(QString::fromStdString(GetMasterCoreVersion()));
    ...
    pixPaint.drawText(pixmap.width()-titleTextWidth-paddingRight+2,paddingTop+titleCopyrightVSpace,copyrightText);
    pixPaint.drawText(pixmap.width()-titleTextWidth-paddingRight+2,paddingTop+titleCopyrightVSpace+titleCopyrightMSCVSpace,copyrightMSC);
