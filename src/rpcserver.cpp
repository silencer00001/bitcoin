...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "omni layer",   "getinfo_MP",                   &getinfo_MP,                    true,   false,  false },
    { "omni layer",   "getallbalancesforid_MP",       &getallbalancesforid_MP,        false,  false,  false },
    { "omni layer",   "getbalance_MP",                &getbalance_MP,                 false,  false,  false },
    { "omni layer",   "send_MP",                      &send_MP,                       false,  false,  true },
    { "omni layer",   "gettransaction_MP",            &gettransaction_MP,             false,  false,  false },
    { "omni layer",   "listtransactions_MP",          &listtransactions_MP,           false,  false,  true },
    { "omni layer",   "getproperty_MP",               &getproperty_MP,                false,  false,  false },
    { "omni layer",   "listproperties_MP",            &listproperties_MP,             false,  false,  false },
    { "omni layer",   "getcrowdsale_MP",              &getcrowdsale_MP,               false,  false,  false },
    { "omni layer",   "getgrants_MP",                 &getgrants_MP,                  false,  false,  false },
    { "omni layer",   "getactivedexsells_MP",         &getactivedexsells_MP,          false,  false,  false },
    { "omni layer",   "getactivecrowdsales_MP",       &getactivecrowdsales_MP,        false,  false,  false },
    ...
    { "omni layer",   "getsto_MP",                    &getsto_MP,                     false,  false,  false },
    { "omni layer",   "listblocktransactions_MP",     &listblocktransactions_MP,      false,  false,  false },
    { "omni layer",   "getallbalancesforaddress_MP",  &getallbalancesforaddress_MP,   false,  false,  false },
};
