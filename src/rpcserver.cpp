...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "omni layer",   "send_MP",                      &send_OMNI,                     false,  false,  true },
    ...
    { "hidden",       "trade_MP",                     &trade_MP,                      false,  false,  true }, // depreciated
    { "omni layer",   "sendtrade_OMNI",               &sendtrade_OMNI,                false,  false,  true },
    { "omni layer",   "sendcanceltradesbyprice_OMNI", &sendcanceltradesbyprice_OMNI,  false,  false,  true },
    { "omni layer",   "sendcanceltradesbypair_OMNI",  &sendcanceltradesbypair_OMNI,   false,  false,  true },
    { "omni layer",   "sendcancelalltrades_OMNI",     &sendcancelalltrades_OMNI,      false,  false,  true },
    { "omni layer",   "sendtoowners_MP",              &sendsto_OMNI,                  false,  false,  true },
    ...
    { "omni layer",   "setautocommit_OMNI",           &setautocommit_OMNI,            false,  false,  true },
    ...
    { "omni layer",   "sendissuancemanaged_OMNI",     &sendissuancemanaged_OMNI,       false,  false,  true },
    ...
    { "omni layer raw",   "createsend_OMNI",          &createsend_OMNI,               true,   false,  false },
